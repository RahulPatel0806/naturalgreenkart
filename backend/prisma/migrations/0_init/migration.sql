...
CREATE TABLE `roles` (
    ...
    `name` ENUM('CUSTOMER', 'SELLER', 'ADMIN') NOT NULL,
...
CREATE TABLE `users` (
    ...
    INDEX `users_isBlocked_idx`(`isBlocked`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `otp_codes` (
    ...
    INDEX `otp_codes_phone_createdAt_idx`(`phone`, `createdAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
    ...
    `unit` ENUM('KG', 'GRAM', 'LITRE', 'ML', 'PIECE', 'PACK', 'DOZEN', 'BUNCH') NOT NULL DEFAULT 'PIECE',
...
CREATE TABLE `inventory` (
    ...
    INDEX `inventory_isOutOfStock_idx`(`isOutOfStock`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    `status` ENUM('PENDING', 'ACCEPTED', 'REJECTED', 'PACKED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED') NOT NULL DEFAULT 'PENDING',
    ...
    INDEX `orders_placedAt_idx`(`placedAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `notifications` (
    `id` VARCHAR(191) NOT NULL,
    `userId` VARCHAR(191) NOT NULL,
    `type` ENUM('ORDER_STATUS', 'SYSTEM', 'PROMO') NOT NULL DEFAULT 'ORDER_STATUS',
